...
#AUTHOR : CHIGOZIEWORLDWIDE (SUN)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO SUN
...
header = {"user-agent": '[Mozilla/5.0 (Linux; Android 5.1; S20 Ultra) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/13.2 Chrome/83.0.4103.106 Mobile Safari/537.36;]',
